        ...
        <div class="col-md-7 mt-5 px-2 py-3 modal-form">
            ...
            <div class="row">
                <div class="modal-body">
                    <form action="teste.php" method="POST" class="needs-validation" novalidate>
                        <div class="filters row">
                            ...
                            <div class="col-md-4 filter">
                                ...
                                <input name="Telefone" type="text" id="Telefone" class="form-control form-control-sm" required />
                            ...
                            <div class="col-md-2 filter">
                                ...
                                <input name="Cep" type="text" id="Cep" class="form-control form-control-sm" required />
