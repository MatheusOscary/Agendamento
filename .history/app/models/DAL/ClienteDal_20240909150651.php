...
class ClienteDal{
    ...
    $sql = "INSERT INTO Cliente(Nome, Telefone, Genero, UF, Cidade, CEP, Bairro, Rua, Numero, Data_aniversario, Data_cadastrou, Sessao_cadastrou, Cod_loja) 
    VALUES(:nome, :telefone, :genero, :uf, :cidade, :cep, :bairro, :rua, :numero, :data_aniversario, NOW(), :sessao_cadastrou, :cod_loja)";
