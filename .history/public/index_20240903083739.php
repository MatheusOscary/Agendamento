...
<div class="col-md-12 d-flex">
    ...
    <div class="col-md-10 ">
        <div class="col-md-12 d-flex">
            <div class="col-md-2 mx-1 option-menu">Início</div>
            <div class="col-md-2 mx-1 option-menu">Clientes</div>
            <div class="col-md-2 mx-1 option-menu">Agendamentos</div>
            <div class="col-md-2 mx-1 option-menu">Serviços</div>
            <div class="col-md-2 mx-1 option-menu">Profissionais</div>
        </div>
    </div>
</div>
